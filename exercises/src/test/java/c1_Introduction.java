...
public class c1_Introduction extends IntroductionBase {
    ...
    public void fortune_top_five() {
        ...
        List<String> results = serviceResult.buffer().blockFirst(); //todo: change this line only
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                .subscribe(companyList::add, System.out::println,() -> serviceCallCompleted.set(true))//todo: change this line only
        ;
