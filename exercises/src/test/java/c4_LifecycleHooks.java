...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().log()
                .doOnNext(integer -> counter.incrementAndGet())//todo: change this line only
                ;
    ...
    public void one_to_rule_them_all() {
        ...
        Flux<Integer> flux = Flux.just(1, 2, 3)
                .doOnEach(integerSignal -> signals.add(integerSignal.getType().name()))//todo: change this line only
                ;
